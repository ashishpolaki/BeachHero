...
namespace BeachHero
{
    ...
    public class MapEditor : MonoBehaviour
    {
        ...
        public void SetLineRenderer(Vector3[] points)
        {
            ...
            mapController.SetPathLine(mapNumber - 1, points);
        }
        #endregion
        ...
        public void GenerateLevelVisuals()
        {
            if (mapController != null)
            {
                var linePoints = GenerateBezierCurvePoints(bezierPoints);
                mapController.GenerateLevelVisuals(mapNumber - 1, bezierPoints, linePoints.ToArray());
