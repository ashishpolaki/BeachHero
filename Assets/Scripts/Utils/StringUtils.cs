...
namespace BeachHero
{
    public class StringUtils
    {
        ...
        public const string STATIC_IDLE_ANIM = "Idle_Static";
        ...
        public const string CONSECUTIVE_LOSE_HINT_POWERUPS = "PLEASE USE POWERUPS TO\n COMPLETE THIS LEVEL";
    }

    public class IntUtils
    {
        //Powerup
        public const int SPEEDBOOST_UNLOCK_LEVEL = 8;
        public const int SHIELD_UNLOCK_LEVEL = 12;
