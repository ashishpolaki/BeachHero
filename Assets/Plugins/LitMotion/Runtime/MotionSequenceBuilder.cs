...
namespace LitMotion
{
    internal sealed class MotionSequenceBuilderSource : ILinkedPoolNode<MotionSequenceBuilderSource>
    {
        ...
        public float CurrentDuration => (float)duration;
        ...
        public void OnCompleteInsert(double position, MotionHandle handle)
        {
            MotionManager.AddToSequence(handle, out var motionDuration);
            AddItem(new MotionSequenceItem(position, handle));
    ...
    public struct MotionSequenceBuilder : IDisposable
    {
        ...
        public float CurrentDuration => source.CurrentDuration;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly MotionSequenceBuilder OnComplete(float position, MotionHandle handle)
        {
            CheckIsDisposed();
            source.OnCompleteInsert(position, handle);
            return this;
        }
